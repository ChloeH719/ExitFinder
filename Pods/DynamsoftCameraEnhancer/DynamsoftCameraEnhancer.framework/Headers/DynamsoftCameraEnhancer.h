...
/**
 * Set the frame rate of the video. If the input frame rate is not available, the camera will choose the closest frame rate with the input value.
 *
 ...
 * @endcode
*/
- (void)setScanRegion:(iRegionDefinition* _Nullable)scanRegion error:(NSError * _Nullable * _Nullable)error;
 ...
 * @endcode
*/
- (void)updateAdvancedSettingsFromString:(NSString*)JsonString error:(NSError * _Nullable * _Nullable)error;
